...
class Stitch(object):
    ...
    def __init__(self, image_dir, key_frame, output_dir, img_filter=None):
        ...
        try:
            ...
            if img_filter:
                # remove all files that don't end with .[image_filter]
    ...
    def stitch(self, base_img_rgb, round=0):
        ...
        detector = cv2.xfeatures2d.SURF_create(500,upright=True)
        ...
        print
        ("Closest Image: ", closestImage['path'])
        print
        ("Closest Image Ratio: ", closestImage['inliers'])
        ...
        if (closestImage['inliers'] > 0.1):  # and
            ...
            print
            ("Enlarged Image Shape: ", enlarged_base_img.shape)
            print
            ("Base Image Shape: ", base_img_rgb.shape)
            print
            ("Base Image Warp Shape: ", base_img_warp.shape)
